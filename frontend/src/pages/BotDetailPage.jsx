      ...
      <div className="bg-gray-800 rounded-lg p-6 mb-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
          <div>
            ...
            <p className="text-gray-300 mt-1">{bot.strategy} Strategy • {bot.risk} Risk</p>
          </div>
        ...
        <div className="border-b border-gray-700 mb-6">
          <nav className="flex space-x-8">
            {['overview', 'strategy', 'performance', 'reviews'].map((tab) => (
              <button
                key={tab}
        ...
        <div className="mt-4">
          {activeTab === 'overview' && (
            <div>
              ...
              <p className="text-gray-300">{bot.detailedDescription}</p>
            </div>
          )}
          ...
          {activeTab === 'strategy' && (
            <div>
              ...
              <p className="text-gray-300 mb-6">{bot.detailedDescription}</p>
          ...
          {activeTab === 'performance' && (
            <div>
              ...
              <div className="h-64 bg-gray-700 rounded-lg flex items-end p-4 space-x-2">
                {bot.historicalPerformance?.map((item, index) => (
                  <div key={index} className="flex flex-col items-center">
                    ...
                    <span className="text-xs">{item.return}%</span>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="bg-gray-700 p-4 rounded-lg">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="ml-2 text-sm text-gray-400">User123 - 2 days ago</span>
                  </div>
                  <p className="text-gray-300">This bot has been performing exceptionally well for me. The returns have been consistent and the risk management is solid.</p>
                </div>
              </div>
            </div>
          )}
