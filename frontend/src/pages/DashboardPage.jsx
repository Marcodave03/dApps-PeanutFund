    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        ...
        <button
          ...
          disabled={refreshing}
          className="flex items-center gap-2 px-4 py-2 bg-gray-800 hover:bg-gray-700 rounded-md transition-colors disabled:opacity-50"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-gray-800 p-6 rounded-xl shadow-lg">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-2xl font-bold mt-1">${portfolio?.totalValue?.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
            </div>
        ...
        <div className="bg-gray-800 p-6 rounded-xl shadow-lg">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-gray-400 text-sm font-medium">30d Profit</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <Link to="/marketplace" className="group">
          <div className="h-full bg-gradient-to-br from-blue-900/30 to-blue-900/10 p-6 rounded-xl border border-blue-900/30 hover:border-blue-800/50 transition-all">
            ...
            <p className="text-sm text-gray-400 mt-1">Browse marketplace</p>
          </div>
        </Link>
        ...
        <Link to="/my-bots" className="group">
          <div className="h-full bg-gradient-to-br from-purple-900/30 to-purple-900/10 p-6 rounded-xl border border-purple-900/30 hover:border-purple-800/50 transition-all">
            ...
            <p className="text-sm text-gray-400 mt-1">View and manage</p>
          </div>
        </Link>
        ...
        <Link to="/help" className="group">
          <div className="h-full bg-gradient-to-br from-green-900/30 to-green-900/10 p-6 rounded-xl border border-green-900/30 hover:border-green-800/50 transition-all">
            ...
            <p className="text-sm text-gray-400 mt-1">Get support</p>
          </div>
        </Link>
        ...
        <Link to="/profile" className="group">
          <div className="h-full bg-gradient-to-br from-amber-900/30 to-amber-900/10 p-6 rounded-xl border border-amber-900/30 hover:border-amber-800/50 transition-all">
            ...
            <p className="text-sm text-gray-400 mt-1">Account settings</p>
          </div>
        </Link>
      </div>
        ...
        <div className="p-6 border-b border-gray-700">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              ...
              <p className="text-sm text-gray-400">Your latest bot activities and trades</p>
            </div>
            <button
              onClick={handleRefresh}
              disabled={refreshing}
              className="flex items-center gap-2 px-4 py-2 bg-gray-700 hover:bg-gray-600 rounded-md transition-colors disabled:opacity-50 text-sm"
            >
