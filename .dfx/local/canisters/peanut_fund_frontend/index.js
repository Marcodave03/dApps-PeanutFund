...
import { idlFactory } from './peanut_fund_frontend.did.js';
export { idlFactory } from './peanut_fund_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PEANUT_FUND_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./peanut_fund_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the peanut_fund_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./peanut_fund_frontend.did.js")._SERVICE>}
 */
export const peanut_fund_frontend = createActor(canisterId);
