// frontend/src/pages/BotActivitiesPage.tsx
...
const BotActivitiesPage: React.FC = () => {
  ...
  const getStatusBadge = (status: 'completed' | 'pending' | 'failed'): JSX.Element => {
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-900">
                  {activities.map((activity) => (
                    <tr key={activity.id} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                      ...
                      <td className={`whitespace-nowrap px-3 py-4 text-sm ${activity.action === 'BUY' ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
                        {activity.action}
                      </td>
...
export default BotActivitiesPage;